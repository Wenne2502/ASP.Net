...
namespace Google.Controllers
{
    public class HomeController : Controller
    {
        ...
        private const string redirect_uri = "http://localhost:5051/Home/callback";
            ...
            if (!string.IsNullOrEmpty(code))
            {
                ...
                if (!string.IsNullOrEmpty(GoogleAPIKey))
                {
                    ...
                    if (!string.IsNullOrEmpty(userInfoJson))
                    {
                        ...
                        string giveName = (string)jsonData["given_name"];
                        string pictureUrl = (string)jsonData["picture"];
                        ViewBag.pictureUrl = pictureUrl;
                        ViewBag.Name = giveName;
